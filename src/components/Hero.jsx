// Hero — top landing area with intro text, animated role typewriter,
// CTAs, social links, and a portrait card with floating decoration.
...
function FloatingOrbs() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        className="absolute top-1/3 -right-20 w-[28rem] h-[28rem] rounded-full bg-accent/20 blur-3xl animate-blob"
        style={{ animationDelay: "2s" }}
      />
      <div
        className="absolute -bottom-20 left-1/3 w-96 h-96 rounded-full bg-cyan/30 blur-3xl animate-blob"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full grid lg:grid-cols-[1.3fr_1fr] gap-12 items-center">
        ...
        >
          ...
          <p className="mt-6 max-w-xl text-muted-foreground text-lg">
            I build secure, scalable, and modern web applications with a focus on clean
            architecture, performance, and rock-solid authentication.
          </p>
