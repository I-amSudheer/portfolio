...
export function Projects() {
  return (
    <Section id="projects" eyebrow="Projects" title="Featured Work" description="A selection of recent builds spanning full-stack apps and security tooling.">
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex flex-wrap gap-1.5 mb-5">
                {p.tech.map((t) => (
                  <span key={t} className="px-2.5 py-1 rounded-full text-xs font-medium bg-primary/10 text-primary">
                    {t}
                  </span>
                ))}
              </div>
