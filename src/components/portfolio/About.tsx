  ...
  return (
    <Section id="about" eyebrow="About" title="Crafting Secure Digital Experiences">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <p>
            I am a passionate <span className="text-primary font-semibold">Full Stack Developer</span> focused on building secure, scalable, and user-friendly web applications.
          </p>
          <p>
            I enjoy learning new technologies and sharing my journey through content creation. My primary expertise includes Java, Spring Boot, React, REST APIs, Authentication, Authorization, and JWT Security.
          </p>
          <p>
            I believe in <span className="text-accent font-semibold">continuous learning</span>, consistency, and building real-world solutions.
          </p>
        </motion.div>
