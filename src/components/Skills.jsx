...
const groups = [
  ...
  { title: "Database", skills: [{ name: "MySQL", level: 88 }] },
  {
    title: "Tools",
    skills: [
      { name: "Git", level: 92 },
...
export function Skills() {
  return (
    <Section
      ...
      description="A handpicked stack for building modern, secure full-stack applications."
    >
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {groups.map((g, gi) => (
          ...
          >
            <div className="text-sm font-semibold uppercase tracking-wider text-primary mb-5">
              {g.title}
            </div>
