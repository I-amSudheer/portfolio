// Cursor — custom animated cursor (desktop only). Two layers: a dot
// that follows the pointer and a larger ring that grows over interactive elements.
...
export function Cursor() {
  ...
  useEffect(() => {
    const move = (e) => {
      ...
      const t = e.target;
      setHover(!!(t && t.closest && t.closest("a, button, [data-cursor-hover]")));
    };
